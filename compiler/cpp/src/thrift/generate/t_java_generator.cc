...
void t_java_generator::generate_service_server(t_service* tservice) {
  ...
  indent(f_service_) << "public Processor(I iface, java.util.List<org.apache.thrift.interceptor.Interceptor> interceptors) {" << endl;
  indent(f_service_)
                     << "  super(iface, interceptors, getProcessMap(new java.util.HashMap<java.lang.String, "
                        "org.apache.thrift.ProcessFunction<I, ? extends "
                        "org.apache.thrift.TBase>>()));"
                     << endl;
  indent(f_service_) << "}" << endl << endl;
